...
extension UIColor {
    ...
    static let specialGreenTextColor = #colorLiteral(red: 0.1921568627, green: 0.3490196078, blue: 0.3215686275, alpha: 1)
    ...
    static let specialGrayTextColor = #colorLiteral(red: 0.7607843137, green: 0.7607843137, blue: 0.7607843137, alpha: 1)
    static let specialBlackTextColor = #colorLiteral(red: 0.2470588235, green: 0.2470588235, blue: 0.2470588235, alpha: 1)
}
